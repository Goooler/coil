...
internal class RealDiskCache(
    ...
    private class RealSnapshot(private val snapshot: DiskLruCache.Snapshot) : Snapshot {
        ...
        override val metadata: File get() = snapshot.file(ENTRY_METADATA)
        override val data: File get() = snapshot.file(ENTRY_DATA)
    ...
    private class RealEditor(private val editor: DiskLruCache.Editor) : Editor {
        ...
        override val metadata: File get() = editor.file(ENTRY_METADATA)
        override val data: File get() = editor.file(ENTRY_DATA)
